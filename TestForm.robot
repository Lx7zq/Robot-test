...
${Valid_Thai_Firstname}      เปรมปรีย์
${Valid_Thai_Lastname}      ดีเลิศ
${Valid_English_Name_Title}  Mr.
${Valid_English_Firstname}     Prempree
${Valid_English_Lastname}      Deelert
${Valid_Day}              9
${Valid_Month}            มีนาคม
${Valid_YearB_E}          2547
${Valid_ID_Card}        8710778989098
${Valid_Password}        IsNotPassword1
${Valid_Phone_number}     0748194728
${Valid_Email_Webmail}    654259007@webmail.npru.ac.th
...
Check Invalid Email_Webmail
    ...
    Open Signup Form
    Input Email  Prempree@gmail.com
    Execute JavaScript    ${SCROLL_SCRIPT_DOWN}
    Sleep    2s
    Input Checkbox
    Click Button 
